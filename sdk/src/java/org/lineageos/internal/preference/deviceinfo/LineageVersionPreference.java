...
public class LineageVersionPreference extends SelfRemovingPreference
    ...
    private static final String KEY_HAVOC_VERSION_PROP = "ro.havoc.version";
    ...
    public void onAttached() {
        ...
        setTitle(R.string.havoc_version);
        setSummary(SystemProperties.get(KEY_HAVOC_VERSION_PROP,
